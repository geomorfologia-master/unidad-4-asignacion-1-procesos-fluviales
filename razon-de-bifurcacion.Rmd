...
Sea $N_u=f(u)$. Si graficamos el logaritmo del número de cursos por cada orden de red (según el método de Strahler), notaremos que existe una relación lineal. Este sería un ejemplo con datos reales de la cuenca del arroyo Pantuflas (Constanza, República Dominicana), utilizando el addon de GRASS GIS `r.stream.stats` [@grassrstreamstats]:
