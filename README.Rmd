...
### Coordenadas de cuencas asignadas para ejercicio 3
...
### EJERCICIO 2: Definir proyección de la región de GRASS GIS, importar fuente y utilizarla para definir extensión y resolución. Cómo ver la ayuda de las funciones
