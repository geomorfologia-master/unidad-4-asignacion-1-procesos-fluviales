...
- **En R**:
    ...
    - Importa el DEM desde la región de GRASS mediante la función `readRAST`. Convierte tu DEM a raster con la función `raster` y represéntalo con la función `plot`.
...
- **En GRASS (recuerda desde R**. Lleva tu límite de cuenca a la región de GRASS y úsalo como máscara. Genera un mapa de pendiente, y tráelo a R.
