...
mapview(bas2, zcol='cat', col.regions = 'blue', legend = FALSE) %>% addStaticLabels(zcol = 'cat')
```
...
mapview(bas3, zcol='cat', col.regions = 'blue', legend = FALSE) %>% addStaticLabels(zcol = 'cat')
```
